...
CREATE TABLE "m_doc_category" (
    ...
    "doc_category" VARCHAR(200) NOT NULL,
...
CREATE TABLE "realization" (
    ...
    "no_request" INTEGER,
    "ta_reff" INTEGER,
    "type" "RealizationTypeEnum" NOT NULL DEFAULT 'UANG',
...
-- CreateTable
CREATE TABLE "ReallocationCorporate" (
    ...
    CONSTRAINT "ReallocationCorporate_pkey" PRIMARY KEY ("id_reallocation_corporate")
);

-- CreateTable
CREATE TABLE "ReallocationCorporateItem" (
    ...
    CONSTRAINT "ReallocationCorporateItem_pkey" PRIMARY KEY ("id_reallocation_corporate_item")
);
...
-- CreateIndex
CREATE INDEX "realization_constraint" ON "realization"("years", "cost_center_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "realization_item_constraint" ON "realization_item"("realization_id", "gl_account_id");

-- CreateIndex
CREATE UNIQUE INDEX "reallocation_unique_id_key" ON "reallocation"("unique_id");

-- CreateIndex
CREATE UNIQUE INDEX "ReallocationCorporate_unique_id_key" ON "ReallocationCorporate"("unique_id");

-- CreateIndex
CREATE INDEX "reallocation_budget_constraint" ON "ReallocationCorporate"("years");

-- CreateIndex
CREATE UNIQUE INDEX "ReallocationCorporateItem_unique_id_key" ON "ReallocationCorporateItem"("unique_id");
...
-- AddForeignKey
ALTER TABLE "realization" ADD CONSTRAINT "fk_m_status_to_realization1" FOREIGN KEY ("statusToId") REFERENCES "m_status"("id_status") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "ReallocationCorporate" ADD CONSTRAINT "fk_m_status_to_reallocation_corporate" FOREIGN KEY ("status_id") REFERENCES "m_status"("id_status") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "ReallocationCorporate" ADD CONSTRAINT "fk_m_status_to_reallocation_corporate1" FOREIGN KEY ("id_status_to") REFERENCES "m_status"("id_status") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "ReallocationCorporateItem" ADD CONSTRAINT "fk_m_cost_center_to_reallocation_corporate_item" FOREIGN KEY ("cost_center_id") REFERENCES "m_cost_center"("id_cost_center") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "ReallocationCorporateItem" ADD CONSTRAINT "fk_m_cost_center_to_reallocation_corporate_item1" FOREIGN KEY ("cost_center_to_id") REFERENCES "m_cost_center"("id_cost_center") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "ReallocationCorporateItem" ADD CONSTRAINT "fk_m_gl_account_to_reallocation_corporate_item" FOREIGN KEY ("gl_account_id") REFERENCES "m_gl_account"("id_gl_account") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "ReallocationCorporateItem" ADD CONSTRAINT "fk_m_gl_account_to_reallocation_corporate_item1" FOREIGN KEY ("gl_account_to_id") REFERENCES "m_gl_account"("id_gl_account") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "ReallocationCorporateItem" ADD CONSTRAINT "fk_reallocation_corporate_to_reallocation_corporate_item" FOREIGN KEY ("reallocation_budget_id") REFERENCES "ReallocationCorporate"("id_reallocation_corporate") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "simulation" ADD CONSTRAINT "fk_m_gl_account_to_simulation" FOREIGN KEY ("id_gl_account") REFERENCES "m_gl_account"("id_gl_account") ON DELETE NO ACTION ON UPDATE NO ACTION;
